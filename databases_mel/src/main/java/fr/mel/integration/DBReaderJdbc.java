...
public class DBReaderJdbc implements Processor {
	...
	public void process(Exchange exchange) throws Exception {
		...
		Integer CamelJdbcRowCount=(Integer)message.getHeader("CamelJdbcRowCount");
		logger.log(Level.INFO, "[MEL APPLICATION -JAVA-] :: found " + CamelJdbcRowCount.intValue() + " records");
